...
const TeleRehabAI = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Try to fetch from Python AI Server
                const neuroRes = await fetch('http://localhost:8000/api/neuro-metrics');
                const clinicalRes = await fetch('http://localhost:8000/api/clinical-benchmarks');
